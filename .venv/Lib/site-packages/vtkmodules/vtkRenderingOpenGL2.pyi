...
class vtkGLSLModifierFactory(object):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, __a:'vtkGLSLModifierFactory') -> None: ...
    @staticmethod
...
class vtkOpenGLRenderWindow(vtkmodules.vtkRenderingCore.vtkRenderWindow):
    ...
    open_gl_symbol_loader2:'getset_descriptor'
    ...
    def SetOpenGLSymbolLoader2(self, toolGetProcAddressFunc:int, glLibHandle:int) -> None: ...
    @overload
...
class vtkOpenGLFluidMapper(vtkmodules.vtkRenderingCore.vtkAbstractVolumeMapper):
    ...
    surface_filter_iterations:'getset_descriptor'
    surface_filter_method:'getset_descriptor'
    surface_filter_radius:'getset_descriptor'
    thickness_and_volume_color_filter_iterations:'getset_descriptor'
    ...
    def GetSurfaceFilterIterations(self) -> int: ...
    def GetSurfaceFilterMethod(self) -> vtkOpenGLFluidMapper.FluidSurfaceFilterMethod: ...
    def GetSurfaceFilterRadius(self) -> int: ...
    def GetThicknessAndVolumeColorFilterIterations(self) -> int: ...
    ...
    def SetSurfaceFilterIterations(self, _arg:int) -> None: ...
    def SetSurfaceFilterMethod(self, _arg:vtkOpenGLFluidMapper.FluidSurfaceFilterMethod) -> None: ...
    def SetSurfaceFilterRadius(self, _arg:int) -> None: ...
    def SetThicknessAndVolumeColorFilterIterations(self, _arg:int) -> None: ...
...
class vtkOpenGLVertexBufferObjectGroup(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def InstancingOff(self) -> None: ...
    def InstancingOn(self) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetInstancing(self, _arg:bool) -> None: ...
...
class vtkWin32OpenGLRenderWindow(vtkOpenGLRenderWindow):
    current_cursor:'getset_descriptor'
    ...
    def IsTypeOf(type:str) -> int: ...
    def MakeCurrent(self) -> None: ...
    def NewInstance(self) -> 'vtkWin32OpenGLRenderWindow': ...
    def PopContext(self) -> None: ...
    ...
    def ReportCapabilities(self) -> str: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkWin32OpenGLRenderWindow': ...
    def SetCurrentCursor(self, __a:int) -> None: ...
    def SetCursorPosition(self, x:int, y:int) -> None: ...
    def SetDisplayId(self, __a:Pointer) -> None: ...
    def SetFullScreen(self, __a:int) -> None: ...
    def SetIcon(self, img:'vtkImageData') -> None: ...
    def SetNextWindowId(self, arg:Pointer) -> None: ...
    def SetNextWindowInfo(self, __a:str) -> None: ...
    def SetParentId(self, foo:Pointer) -> None: ...
    def SetParentInfo(self, __a:str) -> None: ...
    @overload
    def SetPosition(self, x:int, y:int) -> None: ...
    @overload
    ...
    def SetWindowId(self, foo:Pointer) -> None: ...
    def SetWindowInfo(self, __a:str) -> None: ...
    def SetWindowName(self, __a:str) -> None: ...
    def ShowCursor(self) -> None: ...
    def WindowInitialize(self) -> None: ...
...
class vtkWin32OpenGLDXRenderWindow(vtkWin32OpenGLRenderWindow):
    d3d_device_context:'getset_descriptor'
    shared_texture_samples:'getset_descriptor'
    size:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def BlitToTexture(self, color:Pointer, depth:Pointer=...) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetSharedTextureSamples(self) -> int: ...
    def Initialize(self) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def Lock(self) -> None: ...
    def NewInstance(self) -> 'vtkWin32OpenGLDXRenderWindow': ...
    def RegisterSharedDisplayFramebuffer(self) -> None: ...
    def RegisterSharedRenderFramebuffer(self) -> None: ...
    def RegisterSharedTexture(self, colorId:int, depthId:int=0) -> None: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkWin32OpenGLDXRenderWindow': ...
    def SetD3DDeviceContext(self, context:Pointer) -> None: ...
    def SetSharedTextureSamples(self, _arg:int) -> None: ...
    def SetSize(self, width:int, height:int) -> None: ...
    def Unlock(self) -> None: ...
    def UnregisterSharedTexture(self) -> None: ...
